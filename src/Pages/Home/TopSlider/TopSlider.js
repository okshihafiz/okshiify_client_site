    ...
    <>
      ...
      >
        ...
        <Box className={classes.rightBox}>
          ...
          <p style={{color:'#fff'}}>DON'T COMPROMISE ON STYLE! GET FLAT 50% OFF NEW ARRIVALS.</p>
          <Button className={classes.secondShopBtn} variant="outlined" color="inherit">SHOP NOW</Button>
          </Box>
          <Box className={classes.leftBox}>
